...
echo Step 1: Preparing all files (IndiLogs)...
powershell -ExecutionPolicy Bypass -Command "& { . .\PrepareFiles.ps1 }"
if errorlevel 1 (
...
echo   powershell -ExecutionPolicy Bypass -File .\DeployToServer.ps1 -Version "1.0.0.6"
echo   (change the version number to match AssemblyInfo.cs)
echo ========================================
pause
